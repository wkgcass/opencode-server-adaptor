/** Provider catalog and OpenCode projection models shared by integrations and routes. */
import type { ProviderConfig, ProviderConfigStore, ProviderModelConfig } from "../config/provider-config.ts"
